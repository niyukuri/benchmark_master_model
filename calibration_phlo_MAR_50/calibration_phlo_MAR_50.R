...
work.dir <-  "/home/dniyukuri/lustre/calibration_phlo_MAR_50"  # on CHPC
...
df <- read.csv("/home/dniyukuri/lustre/calibration_phlo_MAR_50/Results.benchmark.epi.mm.stats_280_123.csv")
...
med.MAR.phylo.features <- med.MAR.phylo.features.cov.50 # c(med.classic.features, med.MAR.phylo.features.cov.50)
...
simpact4ABC.MAR.phylo.50 <- function(inputvector = inputvector){
  ...
  source("/home/dniyukuri/lustre/calibration_phlo_MAR_50/needed.functions.RSimpactHelp.R")
  source("/home/dniyukuri/lustre/calibration_phlo_MAR_50/compute.summary.statistics.classic.R")
  source("/home/dniyukuri/lustre/calibration_phlo_MAR_50/compute.summary.statistics.phylo.MAR.R")
  source("/home/dniyukuri/lustre/calibration_phlo_MAR_50/advanced.transmission.network.builder.R")
...
# d <- simpact4ABC.MAR.phylo.50(inputvector = inputvector)

source("/home/dniyukuri/lustre/calibration_phlo_MAR_50/calibration.ABC.R")


calib.MAR.phylo.50.results <- calibration.ABC(model.sim = simpact4ABC.MAR.phylo.50,
...
save(calib.MAR.phylo.50.results, file = "calib.MAR.phylo.50.results.RData")

...
# work.dir <-  "/home/dniyukuri/lustre/calibration_classic"  # on CHPC
...
# df <- read.csv("/home/dniyukuri/lustre/calibration_classic/Results.benchmark.epi.mm.stats_280_123.csv")
...
# med.classic.features.num <- as.numeric(med.classic.features)

# 
# MCAR.phylo.features.cov.35 <- benchmark_data %>% # 36
#   dplyr::select(contains("MCAR.35"))
...
simpact4ABC.classic <- function(inputvector = inputvector){
  ...
  # source("/home/dniyukuri/lustre/calibration_classic/compute.summary.statistics.classic.R")
...
# d <- simpact4ABC.classic(inputvector = inputvector)


cdf <- calibration.ABC(model.sim = simpact4ABC.classic,
                       sum_stat_obs = med.classic.features,
...
cl <- get(load("/home/david/benchmark_master_model/calibration_classic/calib.class.results.RData"))

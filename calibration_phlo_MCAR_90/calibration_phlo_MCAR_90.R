...
work.dir <-  "/home/dniyukuri/lustre/calibration_phlo_MCAR_90"  # on CHPC
...
df <- read.csv("/home/dniyukuri/lustre/calibration_phlo_MCAR_90/Results.benchmark.epi.mm.stats_280_123.csv")
...
med.MCAR.phylo.features <- med.MCAR.phylo.features.cov.90
...
simpact4ABC.MCAR.phylo.90 <- function(inputvector = inputvector){
  ...
  source("/home/dniyukuri/lustre/calibration_phlo_MCAR_90/needed.functions.RSimpactHelp.R")
  source("/home/dniyukuri/lustre/calibration_phlo_MCAR_90/compute.summary.statistics.classic.R")
  source("/home/dniyukuri/lustre/calibration_phlo_MCAR_90/compute.summary.statistics.phylo.MCAR.R")
  source("/home/dniyukuri/lustre/calibration_phlo_MCAR_90/advanced.transmission.network.builder.R")
  ...
  if (length(results) == 0){
    ...
    if (as.numeric(results["eventsexecuted"]) >= (as.numeric(cfg.list["population.maxevents"]) - 1)) {
      ...
      outputvector <- MCAR.phylo.stats # c(epi.behav.stats, MCAR.phylo.stats)
...
# d <- simpact4ABC.MCAR.phylo.90(inputvector = inputvector)

source("/home/dniyukuri/lustre/calibration_phlo_MCAR_90/calibration.ABC.R")


calib.MCAR.phylo.90.results <- calibration.ABC(model.sim = simpact4ABC.MCAR.phylo.90,
                                                     sum_stat_obs = med.MCAR.phylo.features,
                                                     simpact_prior = simpact_prior, 
                                                     design.points = 1120,
                                                     seed.val = 6975,
                                                     n_cores = 56)

save(calib.MCAR.phylo.90.results, file = "calib.MCAR.phylo.90.results.RData")

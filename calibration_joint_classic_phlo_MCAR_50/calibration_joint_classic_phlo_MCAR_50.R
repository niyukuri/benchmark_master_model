...
work.dir <-  "/home/dniyukuri/lustre/calibration_joint_classic_phlo_MCAR_50"  # on CHPC
...
df <- read.csv("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MCAR_50/Results.benchmark.epi.mm.stats_280_123.csv")
...
# 
# 
MCAR.phylo.features.cov.50 <- benchmark_data %>% # 36
  dplyr::select(contains("MCAR.50"))


med.MCAR.phylo.features.cov.50 <- colMedians(as.matrix(MCAR.phylo.features.cov.50), na.rm = TRUE)


med.classic.MCAR.phylo.features <- c(med.classic.features, med.MCAR.phylo.features.cov.50)
...
simpact4ABC.classic.MCAR.phylo.50 <- function(inputvector = inputvector){
  ...
  source("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MCAR_50/needed.functions.RSimpactHelp.R")
  source("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MCAR_50/compute.summary.statistics.classic.R")
  source("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MCAR_50/compute.summary.statistics.phylo.MCAR.R")
  source("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MCAR_50/advanced.transmission.network.builder.R")
...
# d <- simpact4ABC.classic.MCAR.phylo.50(inputvector = inputvector)

source("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MCAR_50/calibration.ABC.R")


calib.class.MCAR.phylo.50.results <- calibration.ABC(model.sim = simpact4ABC.classic.MCAR.phylo.50,
...
save(calib.class.MCAR.phylo.50.results, file = "calib.class.MCAR.phylo.50.results.RData")

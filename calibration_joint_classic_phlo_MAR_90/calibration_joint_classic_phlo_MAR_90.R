...
work.dir <-  "/home/dniyukuri/lustre/calibration_joint_classic_phlo_MAR_90"  # on CHPC
...
df <- read.csv("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MAR_90/Results.benchmark.epi.mm.stats_280_123.csv")
...
med.classic.MAR.phylo.features <- c(med.classic.features, med.MAR.phylo.features.cov.90)
...
simpact4ABC.classic.MAR.phylo.90 <- function(inputvector = inputvector){
  ...
  source("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MAR_90/compute.summary.statistics.classic.R")
  source("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MAR_90/compute.summary.statistics.phylo.MAR.R")
  source("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MAR_90/advanced.transmission.network.builder.R")
...
# d <- simpact4ABC.classic.MAR.phylo.90(inputvector = inputvector)

source("/home/dniyukuri/lustre/calibration_joint_classic_phlo_MAR_90/calibration.ABC.R")


calib.class.MAR.phylo.90.results <- calibration.ABC(model.sim = simpact4ABC.classic.MAR.phylo.90,
...
save(calib.class.MAR.phylo.90.results, file = "calib.class.MAR.phylo.90.results.RData")
